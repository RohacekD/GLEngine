...
protected:
	...
	mutable std::shared_ptr<Textures::C_Texture>	m_RoughnessMap = nullptr;
	mutable std::shared_ptr<Textures::C_Texture>	m_ColorMap = nullptr;
	mutable std::shared_ptr<Textures::C_Texture>	m_NormalMap = nullptr;
	Physics::Primitives::S_AABB						m_AABB;
	std::shared_ptr<C_MaterialBuffer>				m_Material;
